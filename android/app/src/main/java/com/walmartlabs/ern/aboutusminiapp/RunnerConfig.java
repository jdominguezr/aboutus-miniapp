package com.walmartlabs.ern.aboutusminiapp;

import com.walmartlabs.ern.container.miniapps.AboutusMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = AboutusMiniappActivity.class;
